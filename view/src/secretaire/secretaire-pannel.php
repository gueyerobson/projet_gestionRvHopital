          ...
          <div class="columns is-centered level">
            <div class="column level-item">
              <div class="box"><img class="logo" src="../../images/patient.png"><br>
                <a style="font-size:16px; font-weight:bold;" class="button is-info is-outlined is-rounded">NOUVEAU RENDEZ-VOUS</a>
              </div>
            </div>
            <div class="column level-item">
              <div class="box"><img class="logo" src="../../images/rdv.png"><br>
                <a style="font-size:16px; font-weight:bold;" class="button is-info is-outlined is-rounded">LISTE RENDEZ-VOUS</a>
              </div>
            </div>
            <div class="column level-item">
              <div class="box"><img class="logo" src="../../images/planning.png"><br>
                <a style="font-size:16px; font-weight:bold;" class="button is-info is-outlined is-rounded">PLANNING</a>
              </div>
            </div>
          </div>
        </div>
